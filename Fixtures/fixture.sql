...
CREATE TABLE user (
    ...
    # REPUTACION
    rep_asesino SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    rep_bandido SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    rep_burgues SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    rep_ladron SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    rep_noble SMALLINT UNSIGNED NOT NULL,
    rep_plebe SMALLINT UNSIGNED NOT NULL,
    rep_average SMALLINT UNSIGNED NOT NULL,
