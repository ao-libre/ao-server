...
Sub LoadSini()
    ...
    DropItemsAlMorir = Lector.GetValue("INIT", "DropItemsAlMorir")
    ...
    UsarMundoPropio = Lector.GetValue("MUNDO", "UsarMundoPropio")
    ...
    ConexionAPI = val(Lector.GetValue("ConexionAPI", "Activado"))
...
Sub SaveUserToCharfile(ByVal Userindex As Integer, _
